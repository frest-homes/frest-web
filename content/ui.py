...
UI = {
    ...
    # legal pages (drafts)
    'privacy_body': T(
        'SIA Frest (info@frest.lv) apstrādā jūsu vārdu, e‑pastu un tālruņa numuru tikai, lai atbildētu uz jūsu pieprasījumu un sagatavotu piedāvājumu. Dati netiek nodoti trešajām personām, izņemot pakalpojumu sniedzējus, kas nodrošina e‑pasta nosūtīšanu. Datus glabājam ne ilgāk kā 24 mēnešus pēc pēdējās saziņas. Jums ir tiesības pieprasīt datu labošanu vai dzēšanu, rakstot uz info@frest.lv. Vietne izmanto tikai tehniski nepieciešamās sīkdatnes.',
        'SIA Frest (info@frest.lv) processes your name, e-mail and phone number only to answer your enquiry and prepare an offer. Data is not shared with third parties except the providers that deliver e-mail. We keep data for no longer than 24 months after the last contact. You may request correction or deletion by writing to info@frest.lv. The site uses only technically necessary cookies.'),
    'terms_body': T(
